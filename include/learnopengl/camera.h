...
private:
    ...
    //    Right = glm::vec3(sin(glm::radians(Yaw)), -cos(glm::radians(Yaw)), 0);
    //    Up    = glm::vec3(sin(glm::radians(Pitch)) * cos(glm::radians(Yaw)), sin(glm::radians(Pitch)) * sin(glm::radians(Yaw)) , cos(glm::radians(Pitch)));
    }
};
#endif

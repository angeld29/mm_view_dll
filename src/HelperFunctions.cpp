...
for ( int i = 0 ; patchlist[i].Type!=0 ; i++ )
  {
   ...
   {
    case 1: 
      Intercept(patchlist[i].Instruction, patchlist[i].Source , patchlist[i].Dest , patchlist[i].PatchSize );
      break;
    case 2:
  	  ReplaceCode(patchlist[i].Instruction, patchlist[i].Source , patchlist[i].Dest , patchlist[i].PatchSize );
	break;
	default:break;
   }
  }
